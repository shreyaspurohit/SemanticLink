...
CPPPATH_NODE = '/home/shreyaspurohit/.nvm/v0.8.15/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/home/shreyaspurohit/.node_libraries'
LIBPATH_NODE = '/home/shreyaspurohit/.nvm/v0.8.15/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CC = ['/usr/bin/gcc']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/shreyaspurohit/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/shreyaspurohit/.nvm/v0.8.15'
